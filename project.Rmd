...
```
```{r knn}
train_knn <- knn(kickstart_train, kickstart_test, train_state, k = 200, prob = F, use.all = F)
train_knn 
...
```{r visualize_distributions}
ggplot(kickstart_new, mapping = aes(x = goal)) +
...
new_project <- tibble(goal = c(1000, 9627.803, 27000),
                      ...
                      #main_category = c("Dance", "Film & Video", "Food"),
                      #country = c("LU", "US", "GB"))
